var X00Diamonds = ['30,000 Diamonds and 300,000 Coins','60,000 Diamonds and 600,000 Coins','90,000 Diamonds and 900,000 Coins'];
var X00Processes = [
  ...
  { X00Percent: 18, X00Text: 'Loading static data' },
  { X00Percent: 18, X00Text: 'Loading static data.' },
  { X00Percent: 18, X00Text: 'Loading static data..' },
  { X00Percent: 18, X00Text: 'Loading static data...' },
  { X00Percent: 18, X00Text: 'Loading static data' },
  ...
  { X00Percent: 74, X00Text: 'Receiving data in http response' },
  { X00Percent: 74, X00Text: 'Receiving data in http response.' },
  { X00Percent: 74, X00Text: 'Receiving data in http response..' },
  { X00Percent: 74, X00Text: 'Receiving data in http response...' },
  { X00Percent: 74, X00Text: 'Receiving data in http response... done!' },
  { X00Percent: 84, X00Text: 'Establishing TCP connection' },
  { X00Percent: 84, X00Text: 'Establishing TCP connection.' },
  { X00Percent: 84, X00Text: 'Establishing TCP connection..' },
  { X00Percent: 84, X00Text: 'Establishing TCP connection...' },
  { X00Percent: 84, X00Text: 'Establishing TCP connection... done!' }, 
  { X00Percent: 94, X00Text: '100% done!' },
  { X00Percent: 96, X00Text: 'TCP connection established with [AF_INET] 199.71.232.146.443' },
  { X00Percent: 96, X00Text: 'TCP connection established with [AF_INET] 199.71.232.146.443.' },
  { X00Percent: 96, X00Text: 'TCP connection established with [AF_INET] 199.71.232.146.443..' },
  { X00Percent: 98, X00Text: 'TCP connection established with [AF_INET] 199.71.232.146.443...' },
  { X00Percent: 100, X00Text: 'TCP connection established with [AF_INET] 199.71.232.146.443....' },
];
var X00ProcessCurrent = 0;
/* var X00ProcessDelay = 3000; */
...
function X00ActivitiesAdd() {
  ...
  $('<div style="text-align: center;"><span class="label label-primary" style="font-weight: bold;">' + X00Random(1, 255) + '.' + X00Random(1, 255) + '.' + X00Random(1, 255) + '.' + X00Random(1, 255) + '</span> <span class="label label-default" style="font-weight: bold;">has generated</span> <span class="label label-success" style="font-weight: bold;">' + X00Diamonds[X00Random(0, X00Diamonds.length)] + '</span> <span class="label label-danger" style="font-weight: bold;">' + '</span> <span id="X00ActivitySeconds" class="label label-info" style="font-weight: bold;">0s ago</span></div>').appendTo('#X00Activities').hide().fadeIn(250);
...
$(function() {
  ...
  $('#X00ButtonStart').click(function() {
    if ($('#X00InputUsername').val() == '') {
      ...
      $('#X00Diamonds').html($('#X00InputDiamonds').val());
